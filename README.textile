...
![build badge](https://github.com/seqfu/bam-readcount/actions/workflows/bam-readcount-test.yml/badge.svg?branch=actions-config)

![coveralls badge](https://coveralls.io/repos/seqfu/bam-readcount/badge.svg?branch=master&service=github(Coverage Status)!:https://coveralls.io/github/seqfu/bam-readcount?branch=actions-config)
